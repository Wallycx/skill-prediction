...
module.exports = {
	...
	0: { // Warrior
		...
		42: { // Blade Frenzy
			'*': {
				noInterrupt: [1, 3, 4, 5, 8, 9, 10, 11, 12, 13, 16, 17, 18, 19, 21, 22, 23, 28, 29, 31, 33, 34, 35, 36, 37, 39, 40, '41-0', '41-30', 42],
				hasChains: true
			},
			0: {
				categoryChains: {
	...
	1: { // Lancer
		...
		3: { // Onslaught
			'*': {
				noInterrupt: [2, 3, 4, 9, 8, 10, 11, 12, 13, 15, 21, 23, 24, 25, 26, 27, 28, 29],
